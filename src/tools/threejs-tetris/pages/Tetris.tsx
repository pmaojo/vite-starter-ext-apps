...
import { TetriminoGroup, TetriminoPile, TETRIMINOS, type TetriminoType, type Block } from '../components/Tetrimino';
...
const Tetris: React.FC = () => {
    ...
    const fallIntervalRef = useRef<number | undefined>(undefined);
